...
CREATE TABLE IF NOT EXISTS user_activity_logs (
  ...
  reason TEXT NOT NULL, -- 'inactive_20_days', 'inactive_30_days'
...
-- This function archives users inactive for 20 days and deletes users inactive for 30+ days
...
BEGIN
  -- Archive users inactive for 20 days (but not yet 30 days)
  -- Only archive users that are not already archived
  FOR v_user_record IN
    ...
    WHERE archived = FALSE
      ...
      AND last_active < NOW() - INTERVAL '20 days'
  ...
  -- Also handle users with NULL last_active that are older than 30 days
...
SELECT 
  ...
  CASE
    ...
    WHEN last_active < NOW() - INTERVAL '30 days' THEN 'over_30_days'
